...
1. **Initiative Proficiency**. When you roll Initiative, you can add your Proficiency Bonus to the roll.
...
1. **Tool Proficiency**. You gain proficiency with three different Artisan's Tools of your choice from the Fast Crafting table.

2. **Discount**. Whenever you buy a nonmagical item, you receive a 20 percent discount on it.

3. **Fast Crafting**. When you finish a Long Rest, you can craft one piece of gear from the Fast Crafting table, provided you have the Artisan's Tools associated with that item and have proficiency with those tools. The item lasts until you finish another Long Rest, at which point the item falls apart.
...
1. **Luck Points**. You have a number of Luck Points equal to your Proficiency Bonus and can spend the points on the benefits below. You regain your expended Luck Points when you finish a Long Rest.

2. **Advantage**. When you roll a d20 for a D20 Test, you can spend 1 Luck Point to give yourself Advantage on the roll.
...
1. **Instrument Training**. You gain proficiency with three Musical Instruments of your choice.
...
1. **Enhanced Unarmed Strike**. When you hit with your Unarmed Strike and deal damage, you can deal Bludgeoning damage equal to 1d4 plus your Strength modifier instead of the normal damage of an Unarmed Strike.

2. **Damage Rerolls**. Whenever you roll a damage die for your Unarmed Strike, you can reroll the die if it rolls a 1, and you must use the new roll.
...
Your Hit Point maximum increases by 2 Hit Points. Whenever you gain a character level, your Hit Point maximum increases by an additional 2 Hit Points.
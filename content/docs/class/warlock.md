...
1. **Armor of Shadows**. You can cast [Mage Armor](/docs/spells/#mage-armor) on yourself without expending a spell slot.
...
**Cantrips**. You know two Warlock cantrips: [Eldritch Blast](/docs/spells/#eldritch-blast) and [Prestidigitation](/docs/spells/#prestidigitation). Whenever you gain a Warlock level, you can replace one of your cantrips from this feature with another Warlock cantrip of your choice.
...
**Prepared Spells**. Each day, you prepare two level 1 spells. Today, you prepared [Charm Person](/docs/spells/#charm-person) and [Hex](/docs/spells/#hex). The number of spells you can prepare increases as you gain Warlock levels.
